...
public class ShoppingListItemCreateRequestValidator : AbstractValidator<ShoppingListItemCreateRequest>
{
    private readonly IUnitOfWork _uow;

    public ShoppingListItemCreateRequestValidator(IUnitOfWork uow)
    {
